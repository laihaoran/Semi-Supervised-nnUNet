...
if __name__ == "__main__":
    base = "/public/huangmeiyan/nnUNet/nnunetdata/nnUNet_raw/nnUNet_raw_data/Task511_KiPA2022/"
    out = "/public/huangmeiyan/nnFormer/nnformerdata/nnFormer_raw/nnFormer_raw_data/Task511_KiPA2022"
    cases = os.listdir(join(base,"labelsTr"))
    ...
    # for i in os.listdir(join(base,'imagesTr')):
    #     shutil.copy(join(base,'imagesTr', i), join(out, "imagesTr", i))
    # for i in os.listdir(join(base,"labelsTr")):
    #     shutil.copy(join(base, "labelsTr", i), join(out, "labelsTr", i))


    json_dict = {}
    json_dict['name'] = "KiPA2022"
    json_dict['description'] = "kidney parsing"
