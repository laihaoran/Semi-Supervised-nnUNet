...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None):
    ...
    assert issubclass(tr, nnFormerTrainer) or issubclass(tr, nnFormerTrainer_last_cut), "The network trainer was found but is not a subclass of nnFormerTrainer.Please make it so!"
