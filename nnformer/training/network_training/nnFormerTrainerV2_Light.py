...
from nnformer.network_architecture.generic_UNet_last_cut import Generic_UNet, Generic_LUNet, SeparableConv3d
...
class nnFormerTrainerV2_Light(nnFormerTrainer_last_cut):
    """
