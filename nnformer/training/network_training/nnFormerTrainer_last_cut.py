...
from nnformer.training.network_training.network_trainer_last_cut import NetworkTrainer
...
class nnFormerTrainer_last_cut(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(nnFormerTrainer_last_cut, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(nnFormerTrainer_last_cut, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(nnFormerTrainer_last_cut, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
