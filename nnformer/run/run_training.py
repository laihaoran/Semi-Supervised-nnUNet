...
# from nnformer.training.network_training.nnFormerTrainerV2_LiverTumorUNETR import nnFormerTrainerV2_LiverTumorUNETR
...
def main():
    ...
    parser.add_argument("--network_trainer", type=str, default='nnFormerTrainerV2_MNet')
    parser.add_argument("--gpu", type=str, default='3', help="can be task name or task id")
    parser.add_argument("--task", type=str, default='Task511_KiPA2022', help="can be task name or task id")
    parser.add_argument("--fold", type=str, default='4', help='0, 1, ..., 5 or \'all\'')
    ...
    print('Your are using run training')
    task = args.task
    fold = args.fold
    ...
    if network == "3d_cascade_fullres":
        ...
        assert issubclass(trainer_class,
                          nnFormerTrainer) or issubclass(
            trainer_class,
            nnFormerTrainer_last_cut), "network_trainer was found but is not derived from nnFormerTrainer"
