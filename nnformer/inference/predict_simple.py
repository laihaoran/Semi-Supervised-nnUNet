...
def main():
    ...
    # parser.add_argument("-i", '--input_folder',default='/home/dell/Public/laihaoran/nnFormer/testset/', help="Must contain all modalities for each patient in the correct"
    #                                                  " order (same as training). Files must be named "
    #                                                  "CASENAME_XXXX.nii.gz where XXXX is the modality "
    #                                                  "identifier (0000, 0001, etc)")
    # parser.add_argument('-o', "--output_folder", default='/home/dell/Public/laihaoran/nnFormer/testsetout/', help="folder for saving predictions")
    # parser.add_argument('-t', '--task_name', help='task name or task ID, required.',
    #                     default='Task134_FLARE2022')
    ...
    #                          % default_trainer,
    #                     required=False,
    #                     default='nnFormerTrainerV2_Dual_Light')
